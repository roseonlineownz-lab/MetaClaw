...
```
(वैकल्पिक) WeChat व्यक्तिगत खाता ब्रिज ([Node.js](https://nodejs.org/) PATH में होना चाहिए؛ SDK के अनुसार ≥ 22 अनुशंसित)।

- **OpenClaw एक-क्लिक प्लगइन** से इंस्टॉल पर WeChat के लिए Node निर्भरताएँ स्वतः लगती हैं।
- **pip** से इंस्टॉल पर `pip install` के बाद एक बार Node निर्भरताएँ लगाएँ:

```bash
cd metaclaw/wechat_node && npm install
```

फिर WeChat सक्षम करें:

```bash
metaclaw config wechat.enabled true
```

कॉन्फ़िग में `wechat.bridge_dir` सेट करने पर उस डायरेक्टरी में `npm install` चलाएँ। पूरा सेटअप (QR लॉगिन, पुनः लॉगिन, समस्या निवारण): [`metaclaw/wechat_node/README.md`](../metaclaw/wechat_node/README.md)।
